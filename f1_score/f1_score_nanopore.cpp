...
void read_file_and_fill_matrix(char *fname,char *dirname)
{
	...
	if(fname[file_name_len-4]=='e'&&fname[file_name_len-4]=='d' &&fname[file_name_len-4]=='f' && fname[file_name_len-3]=='a'&& fname[file_name_len-2]=='s'&& fname[file_name_len-1]=='t'&& fname[file_name_len]=='a');
		isalfasta=true;
